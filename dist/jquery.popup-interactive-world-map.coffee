  ...
  $.fn[pluginName] = (options) ->
    jQuery(this).each ->
      ...
      $.each websites, (index, web) ->
        classBtn = if web.main then settings.classes.websites else 'regularBtn'
        # if setted main then we show the button else just a regular link
